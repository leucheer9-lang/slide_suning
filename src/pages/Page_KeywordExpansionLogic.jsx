            ...
            <div className="w-full max-w-[1650px] mx-auto flex flex-col h-full relative z-10 pt-0 gap-3.5 lg:gap-4">
                ...
                <div className="shrink-0 flex flex-col gap-2">
                    ...
                    <div className="bg-white/[0.02] border border-white/[0.08] rounded-xl p-4 lg:p-5 mt-1">
                        <p className="text-zinc-300 text-[16px] lg:text-[17.5px] xl:text-[19px] leading-relaxed">
                            将生成的<strong className="text-white font-bold">专业核心词条、用户搜索意图、搜索引擎推荐、社媒长尾词及大模型预测词</strong>所有核心维度深度结合，拓宽衍生出更符合用户真实检索场景的长尾词与高价值关联词库。
                        </p>
                    </div>
                </div>
                ...
                <div className="w-full flex-1 flex items-start justify-start min-h-[300px] lg:min-h-[400px]">
                    <div className="relative h-full w-fit border border-white/10 rounded-2xl overflow-hidden bg-white/[0.01] shadow-2xl flex items-center justify-center">
                        <img
                            src="/Add_Charts/keyword-expansion-logic.png"
                            alt="词条拓展逻辑图"
                        ...
                        <div className="fallback-ui absolute inset-0 z-10 flex-col items-center justify-center pointer-events-none p-4 hidden">
                            ...
                            <span className="text-zinc-500/80 text-xs mt-2 font-mono">
                                文件路径: /Add_Charts/keyword-expansion-logic.png
                            </span>
                        </div>
                    </div>
                </div>
