        ...
        <div className="w-full h-full flex flex-col relative bg-black overflow-hidden text-white font-sans px-12 sm:px-16 pt-5 pb-10 animate-fade-in">
            ...
            <div className="text-center mb-4 mt-[-20px] shrink-0 relative z-10">
                ...
                <p className="inline-block text-[#004CE5] text-[1.1rem] font-bold tracking-widest bg-[#004CE5]/10 px-6 py-2 rounded-full border border-[#004CE5]/30 shadow-[0_0_20px_rgba(0,76,229,0.15)]">
                    构建具备高置信度与物证溯源的产业园区招商行业大模型(GEO)监测基准
                </p>
            </div>
                    ...
                    <div className="flex-1 bg-[#09090b] border-2 border-white/10 rounded-2xl p-6 lg:p-8 shadow-2xl relative flex flex-col justify-between gap-5">
                        ...
                        <div className="flex items-start gap-4 relative z-10 py-2 border-b border-white/5">
                            ...
                            <div className="flex-1">
                                <span className="text-2xl lg:text-3xl xl:text-4xl font-black text-white tracking-wide">创维创新谷</span>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4 relative z-10 py-2 border-b border-white/5">
                            ...
                            <div className="flex-1">
                                <span className="text-2xl lg:text-3xl xl:text-4xl font-black text-white tracking-wide">产业园区 / 厂房写字楼招商</span>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col relative z-10 py-2 border-b border-white/5">
                            <div className="flex items-start gap-4">
                                ...
                                <div className="flex-1 flex flex-col gap-1">
                                    <div className="flex items-baseline gap-2">
                                        <span className="text-xl lg:text-2xl xl:text-3xl font-black text-white">优化词 50 项</span>
                                        <span className="text-zinc-400 text-sm lg:text-base font-bold">/ 另设 40 项监测词跟踪品牌舆情</span>
                                    </div>
                                </div>
                            </div>
                            <div className="ml-28 mt-2.5">
                                <div className="text-zinc-300 text-sm lg:text-base leading-relaxed bg-white/[0.03] border border-white/5 rounded-xl p-4">
                                    优化词 50 个，即用户不带品牌名搜索选址需求时的问法，分 C 端（企业自主选址）与 B 端（中介渠道带客）各 25 条，是本次分析与优化的主体；另设监测词 40 个（用户主动问创维创新谷），只用于跟踪品牌舆情与错误信息。
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4 relative z-10 py-2">
                            ...
                            <div className="flex-1">
                                <div className="flex flex-col gap-3">
                                    <span className="text-xl lg:text-2xl xl:text-3xl font-black text-white">2 个主流 AI 大模型平台</span>
                        ...
                        <div className="bg-white/[0.01] border border-white/5 rounded-xl p-6 lg:p-8 relative flex flex-col justify-start gap-8 xl:gap-10 flex-1">
                            ...
                            <div className="flex flex-col gap-2.5">
                                ...
                                <p className="text-[17px] lg:text-[19.5px] xl:text-[22px] text-zinc-200 leading-relaxed tracking-wide">
                                    本周期以 <span className="text-white font-black underline decoration-[#004CE5] decoration-2 underline-offset-4">50 条优化词</span> 为主体，分 C / B 两端监测。C 端提及率 24%、影响力第 8；B 端提及率仅 2%、影响力第 85。两端头部竞品均为新桥东先进制造产业园。另设 <span className="text-white font-black underline decoration-[#004CE5] decoration-2 underline-offset-4">40 条监测词</span> 跟踪品牌舆情。
                                </p>
                            </div>
                            ...
                            <div className="pt-8 border-t border-white/5 flex flex-col gap-3">
                                ...
                                <p className="text-[17px] lg:text-[19.5px] xl:text-[22px] text-zinc-300 leading-relaxed text-justify tracking-wide">
                                    本周期共监测 <span className="text-white font-black">90</span> 个关键词条（优化词 50 + 监测词 40），在 <span className="text-white font-black">2</span> 个平台完成 <span className="text-white font-black">1</span> 天查询，合计执行查询 <strong className="text-[#004CE5] font-black font-mono text-xl lg:text-2xl xl:text-3xl">180</strong> 次，
                                    在优化词场景抓取并识别引用来源 <strong className="text-[#004CE5] font-black font-mono text-xl lg:text-2xl xl:text-3xl">1,527</strong> 次（C 端 718 次 / B 端 809 次），同期识别竞品品牌 C 端 <strong className="text-[#004CE5] font-black font-mono text-xl lg:text-2xl xl:text-3xl">166</strong> 家、B 端 <strong className="text-[#004CE5] font-black font-mono text-xl lg:text-2xl xl:text-3xl">175</strong> 家，
