            ...
            <div className="flex-1 w-full max-w-[1550px] mx-auto px-6 lg:px-8 xl:px-10 pb-8 lg:pb-12 xl:pb-16 relative z-10 flex flex-col lg:flex-row gap-6 lg:gap-8 min-h-0 items-stretch">
                ...
                <div className="flex-[1.05] flex flex-col gap-4 min-h-0">
                    ...
                    <div className="flex-1 bg-[#09090b] border-2 border-white/10 rounded-2xl p-5 lg:p-6 shadow-2xl relative flex flex-col min-h-0">
                        ...
                        <div className="bg-white/[0.01] border border-white/5 rounded-xl px-6 py-7 lg:px-7 lg:py-8 relative flex flex-col justify-center gap-5 lg:gap-6 flex-1 min-h-0 overflow-hidden">
                            <div className="absolute left-0 top-0 bottom-0 w-1.5 bg-[#004CE5] rounded-l-xl"></div>
                            
                            {/* Date Summary */}
                            <div className="flex flex-col gap-2.5">
                                <div className="flex items-center gap-2.5">
                                    <span className="w-2 h-2 rounded-full bg-[#004CE5] shrink-0"></span>
                                    <span className="text-[15px] lg:text-[16px] text-zinc-400 font-black tracking-wider">周期范围</span>
                                </div>
                                <p className="text-[18px] lg:text-[19px] xl:text-[20px] text-zinc-200 leading-[1.7] tracking-normal">
                            ...
                            <div className="pt-5 border-t border-white/5 flex flex-col gap-2.5">
                                <div className="flex items-center gap-2.5">
                                    <span className="w-2 h-2 rounded-full bg-[#004CE5] shrink-0"></span>
                                    <span className="text-[15px] lg:text-[16px] text-zinc-400 font-black tracking-wider">指标详情</span>
                                </div>
                                <p className="text-[18px] lg:text-[19px] xl:text-[20px] text-zinc-300 leading-[1.7] tracking-normal">
                                    本周期共监测 <span className="text-white font-black">50</span> 个关键词条，在 <span className="text-white font-black">4</span> 个平台完成 <span className="text-white font-black">1</span> 天连续查询，合计执行查询 <strong className="text-[#004CE5] font-black font-mono text-[20px] lg:text-[21px] xl:text-[22px]">200</strong> 次，抓取并识别引用文章 <strong className="text-[#004CE5] font-black font-mono text-[20px] lg:text-[21px] xl:text-[22px]">2,501</strong> 篇，同期识别竞品品牌 <strong className="text-[#004CE5] font-black font-mono text-[20px] lg:text-[21px] xl:text-[22px]">84</strong> 家，截图覆盖率达 <strong className="text-[#004CE5] font-black font-mono text-[20px] lg:text-[22px] xl:text-[24px]">100%</strong>。<span className="whitespace-nowrap">各项数据指标均在预期执行范围内，整体运行稳定。</span>
                                </p>
                            </div>
                        </div>
