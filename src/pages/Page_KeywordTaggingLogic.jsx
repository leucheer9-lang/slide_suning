...
const ROWS = [
    {
        ...
        name: '产业园和写字楼有什么区别',
        desc: '用户在问业态概念和定义，要的是科普解释，不会据此选盘或带客。',
        keyword: '产业园和写字楼有什么区别',
        tag: '非购买意图',
        tagColor: TAG.slate,
        note: '用户倾向于获取业态科普，而非具体园区购买或带客决策。',
    },
    {
        type: '2.产品-核心痛点',
        typeColor: TAG.green,
    ...
    },
    {
        ...
        desc: '官方招商页强调直租与免佣金服务，中介佣金点位未公开，不宜把「佣金最高」当差异化投放。',
    ...
    },
    {
        ...
        typeColor: TAG.red,
        name: '园区好不好看、气派不气派',
        desc: '问法只停留在观感，没有面积、业态、带客或入驻约束，决策指向弱。',
        keyword: '宝安好看的产业园',
        tag: '搜索意图低',
        tagColor: TAG.teal,
        note: '问法过宽，没有带客、面积或业态指向，购买决策弱。',
    },
    {
        type: '1.行业-购买动机',
        typeColor: TAG.blue,
        name: '佣金高、结算快',
        desc: '中介收入看佣金点位和回款速度，倾向选择佣金有竞争力、结佣不拖的园区。',
