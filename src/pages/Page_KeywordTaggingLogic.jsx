...
const ROWS = [
    {
        ...
        typeColor: TAG.teal,
        name: '清洁配方少添加',
        desc: '关注配料的家长希望配方简单、添加剂少，干净配料表更容易建立信任',
        keyword: '无添加剂的面包推荐',
        tag: '重复',
        tagColor: TAG.green,
        note: '终版未保留；与「品质好的面包推荐」意图重叠。',
    },
    {
        type: '2.产品-核心痛点',
        typeColor: TAG.green,
        name: '现烤外卖分流',
        desc: '社区团购、即时配送现烤「更新鲜」，冲击预包装「今晚买明天吃」逻辑',
        keyword: '现烤外卖新鲜面包推荐',
        tag: '跟目标产品不符',
        tagColor: TAG.purple,
        note: '主词指向现烤/外卖现做面包，与预包装面包品类不符。',
    },
    {
        type: '3.搜索',
