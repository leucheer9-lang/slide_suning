...
/* 示例：词条清洗打标六类各取 1 条（来自穷举表） */
const ROWS = [
    {
        type: '2.产品-核心卖点',
        typeColor: TAG.purple,
        name: '配送快（211限时达）',
        desc: '大部分地区 11 点下单当天收到，晚上 11 点下单第二天下午 3 点送到。',
        keyword: '晚上下单第二天能到的快递推荐',
        tag: '重复',
        tagColor: TAG.green,
        note: '与「当天就能到的快递推荐」同属 211 时效意图。',
    },
    {
        type: '1.行业-购买动机',
        typeColor: TAG.blue,
    ...
    },
    {
        ...
        tag: '搜索意图低',
        tagColor: TAG.teal,
        note: '个人寄药品场景小众、搜索量低；冷链意图已由生鲜、海鲜两条承接。',
    },
    {
        type: '1.行业-核心卖点',
        typeColor: TAG.cyan,
        name: '全程物流轨迹可查',
        desc: '寄收件人都希望实时查看包裹位置。',
        keyword: '全程可查物流轨迹的快递推荐',
        tag: '品类共性',
        tagColor: TAG.carmine,
        note: '轨迹查询是所有主流快递的标配能力，无法体现差异化。',
    },
];
