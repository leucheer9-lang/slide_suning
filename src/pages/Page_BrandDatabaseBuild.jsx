...
export default function Page_BrandDatabaseBuild() {
    return (
        <div className="w-full h-full flex flex-col relative bg-black overflow-hidden text-white font-sans pt-4 pb-6 px-6 lg:pt-5 lg:pb-8 lg:px-8 xl:pt-6 xl:pb-10 xl:px-10 animate-fade-in">
            {/* Background Pattern */}
            <div className="absolute inset-0 bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:40px_40px] opacity-20 pointer-events-none"></div>

            <div className="w-full max-w-[1650px] mx-auto flex flex-col h-full relative z-10 pt-0 gap-4 xl:gap-5">
                ...
                <div className="shrink-0 flex flex-col gap-2.5">
                    ...
                    <div className="bg-gradient-to-r from-[#004CE5]/20 via-[#004CE5]/5 to-black border border-[#004CE5]/40 rounded-2xl p-5 lg:p-6 shadow-[0_0_35px_rgba(0,76,229,0.3)] relative overflow-hidden flex flex-col md:flex-row md:items-center gap-4 lg:gap-5 mt-1.5">
                ...
                <div className="flex-1 flex flex-col gap-4 lg:gap-5 min-h-0">
                    ...
                    <div className="bg-[#080809] border border-white/10 rounded-[1.5rem] p-5 lg:p-6 flex flex-col gap-4.5 shadow-2xl relative overflow-hidden">
                        {/* Title and Scenario */}
                        <div className="shrink-0 flex items-center justify-between border-b border-white/5 pb-3">
                            <div className="flex items-center gap-3.5">
                                <span className="bg-[#004CE5]/10 border border-[#004CE5]/30 text-[#004CE5] px-3.5 py-1 rounded text-sm lg:text-[14.5px] xl:text-[16px] font-black tracking-widest uppercase">
                                    存量输入
                                </span>
                                <span className="text-white font-black text-[18px] lg:text-[21px] xl:text-[24px]">消除 AI 认知空白</span>
                            </div>
                            <p className="text-zinc-400 text-sm lg:text-[15.5px] xl:text-[17px]">
                        ...
                        <div className="flex flex-col lg:flex-row gap-5 xl:gap-6 items-stretch">
                            {/* Table (72% width) */}
                            <div className="flex-[2.5] border border-white/5 rounded-xl bg-black/40 overflow-hidden flex flex-col justify-center">
                                <table className="w-full text-left border-collapse text-[15px] lg:text-[17px] xl:text-[19px] leading-relaxed">
                                    <thead>
                                        <tr className="bg-white/5 border-b border-white/10 text-zinc-400 font-bold">
                                            <th className="py-3 px-5 border-r border-white/5 w-[22%] text-[16px] lg:text-[18px] xl:text-[20px] font-extrabold text-zinc-200">资产分类</th>
                                            <th className="py-3 px-5 text-[16px] lg:text-[18px] xl:text-[20px] font-extrabold text-zinc-200">具体导入内容</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr className="border-b border-white/5 hover:bg-white/[0.02] transition-colors">
                                            <td className="py-3 px-5 border-r border-white/5 font-black text-zinc-100 flex items-center gap-2.5">
                            ...
                            <div className="flex-1 bg-blue-950/15 border border-[#004CE5]/20 rounded-xl p-5 lg:p-6 flex items-start gap-4 shadow-[inset_0_0_20px_rgba(0,76,229,0.05)]">
                    ...
                    <div className="bg-[#080809] border border-white/10 rounded-[1.5rem] p-5 lg:p-6 flex flex-col gap-4.5 shadow-2xl relative overflow-hidden">
                        ...
                        <div className="shrink-0 flex items-center justify-between border-b border-white/5 pb-3">
                            <div className="flex items-center gap-3.5">
                                <span className="bg-purple-500/10 border border-purple-500/30 text-purple-400 px-3.5 py-1 rounded text-sm lg:text-[14.5px] xl:text-[16px] font-black tracking-widest uppercase">
                                    动态调整
                                </span>
                                <span className="text-white font-black text-[18px] lg:text-[21px] xl:text-[24px]">防范与修正偏差</span>
                            </div>
                            <p className="text-zinc-400 text-sm lg:text-[15.5px] xl:text-[17px]">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 xl:gap-6">
                            ...
                            <div className="bg-black/40 border border-white/5 hover:border-purple-500/20 rounded-xl p-5 lg:p-6 flex items-start gap-4 transition-all duration-300 hover:-translate-y-0.5 shadow-lg">
                            ...
                            <div className="bg-black/40 border border-white/5 hover:border-red-500/20 rounded-xl p-5 lg:p-6 flex items-start gap-4 transition-all duration-300 hover:-translate-y-0.5 shadow-lg">
