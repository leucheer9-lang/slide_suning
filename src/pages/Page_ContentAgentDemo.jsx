...
/* 视频占位框：优先加载 /public/videos/content-agent-demo.mp4，
...
export default function Page_ContentAgentDemo() {
  const [playing, setPlaying] = useState(false);
    ...
    <SlideLayout fullBleed>
      ...
      >
        ...
        <p className="text-[28px] text-white font-['MiSans'] font-medium tracking-wide">
          <span className="text-[#7FA6FF] font-bold">内容撰写Agent</span>　·　实时演示
        </p>
      </div>
    </SlideLayout>
  );
...
Page_ContentAgentDemo.hideHeader = true;
