...
export default function Page_DeliveryHighWeight() {
  ...
  return (
    <SlideLayout title="精准高权重信源——什么是不准的？">
      {/* ── 背景设计 ── */}
      ...
      {/* ── 主排版区 (高度 795px) ── */}
      <div
        className="absolute w-full select-none animate-fadeIn flex flex-col justify-between z-10 pl-0"
      ...
      >
        ...
        <div className="w-full flex gap-6 items-stretch h-[690px] relative">
          ...
          {/* ==================== 2. 右侧：图片展示区 (1376px) ==================== */}
          <div className="flex-1 min-w-0 h-full rounded-[24px] overflow-hidden relative group">
            <img
