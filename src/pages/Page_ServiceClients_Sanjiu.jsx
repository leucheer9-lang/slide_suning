...
export default function Page_ServiceClients_Sanjiu() {
  const clientGroups = [
    {
      category: '大健康与医疗',
      logos: [
        { src: '/images/client-health-diqiao.png', label: '迪巧' },
        { src: '/images/client-health-crsanjiu.png', label: '华润三九' },
        { src: '/images/client-health-ufh.png', label: '和睦家医疗' },
        { src: '/images/client-health-astrazeneca.png', label: '阿斯利康' },
        { src: '/images/client-health-jdhealth.png', label: '京东健康' }
      ],
      extraLogos: [
        { src: '/images/client-health-3sbio.png', label: '三生生物' },
        { src: '/images/client-health-sanjiuyiyao.png', label: '三九医药' },
        { src: '/images/client-health-999ganmaoling.png', label: '999感冒灵' },
        { src: '/images/client-health-sanjiuweitai.png', label: '三九胃泰' }
      ]
    },
    {
      category: '家居家电',
              ...
              {clientGroups.map((group, groupIdx) => (
                <div key={groupIdx} className="flex items-center gap-6">
                  ...
                  <span
                    ...
                    style={{ fontSize: '22px', width: '176px' }}
                  >
                    {group.category}
                  </span>
                  ...
                  <div className="flex flex-col gap-2.5">
                    ...
                    {group.extraLogos?.length > 0 && (
                      <div className="flex items-center gap-3">
                        {group.extraLogos.map((logo, logoIdx) => (
                          <LogoSlot
                            key={logoIdx}
                            src={logo.src}
                            label={logo.label}
...
Page_ServiceClients_Sanjiu.hideHeader = true;
