...
export function Page_ContentAgentArticleDemo1() {
    return <ArticleDemo src="/charts/geo-article-generation-demo2.png" alt="排行榜类文章示意 1" />;
}
Page_ContentAgentArticleDemo1.hideHeader = true;

export function Page_ContentAgentArticleDemo2() {
    return <ArticleDemo src="/charts/geo-article-generation-demo3.png" alt="排行榜类文章示意 2" />;
}
