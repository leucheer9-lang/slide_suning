...
/* 示例：词条穷举表中「类别」各取 1 条（本轮无「2.产品-核心痛点」） */
const ROWS = [
    {
        type: '0.固定',
        tag: TAG.slate,
    ...
    },
    {
        ...
        tag: TAG.blue,
        name: '寄件第一诉求是快',
        desc: '个人寄件最主流的决策标准是「哪家快」，急件、赶时间场景直接按速度选快递。',
        keyword: '速度快的快递排行榜',
    },
    {
        type: '1.行业-场景画像',
        tag: TAG.orange,
        name: '加急寄文件',
        desc: '合同、证件等急件对时效极度敏感，要求当天/次日必达。',
    ...
    },
    {
        ...
        tag: TAG.yellow,
        name: '丢件损坏理赔难',
        desc: '快递丢失、损坏后理赔流程长、赔付低，是投诉最集中的痛点。',
        keyword: '寄贵重物品不丢件的快递推荐',
    },
    {
        type: '2.产品-购买动机',
        tag: TAG.teal,
        name: '寄件品类多样',
        desc: '手机电脑、大家居、家电、生鲜都可以寄递。',
        keyword: '寄家具家电的快递推荐',
    },
    {
        type: '2.产品-场景画像',
        tag: TAG.red,
        name: '顺手寄',
        desc: '收货同时顺手寄快递，不用单独约快递员。',
        keyword: '收快递时能顺手寄件的快递推荐',
    },
    {
        type: '2.产品-核心卖点',
        tag: TAG.purple,
