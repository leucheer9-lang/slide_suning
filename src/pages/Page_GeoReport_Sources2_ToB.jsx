...
const RANKINGS = [
    { name: '腾讯新闻', value: '6.9%', pct: 100 },
    { name: '百度知道', value: '5.2%', pct: 75 },
    { name: '今日头条', value: '3.3%', pct: 48 },
    { name: 'hangyeob.com', value: '2.8%', pct: 41 },
    { name: '新京报', value: '2.6%', pct: 38 },
];

const INSIGHTS = [
    {
        title: '信源偏资讯与行业垂直站，B端产业内容不足',
        accent: '#004CE5',
        body: 'B 端引用池集中在腾讯新闻、百度知道、今日头条与 hangyeob.com 等行业垂直站。大模型更容易抓取大众资讯与问答内容，京东物流需要在这些高权重渠道持续输出"仓配一体、分仓履约"等可被核验的 B 端场景证据。',
    },
    {
        title: '高引用文章里本品露出不稳定',
        accent: '#F59E0B',
        body: 'Top 引用文章多为仓配代发推荐与跨境物流评测，多篇并未稳定提及京东物流。若不对 B 端行业报告与横向对比内容做主动布局，AI 会继续把"首选"写给顺丰或申通等竞品。',
    },
];
                        ...
                        <div className="flex-1 min-h-0 bg-white/[0.02] backdrop-blur-xl border border-white/[0.08] rounded-2xl p-5 lg:p-6 flex flex-col gap-4">
                            ...
                            <div className="flex-[1.05] min-h-0 flex flex-col justify-between text-[15px] lg:text-[16px] xl:text-[18px] text-zinc-300 leading-relaxed">
                                <p className="text-justify">
                                    监测数据显示，决定<strong className="text-white font-semibold">京东物流</strong>在 B 端 AI
                                    问答中表现的最底层数据抓取来源，呈现出
                                    <strong className="text-white font-semibold">"资讯媒体 + 行业垂直站 + UGC 问答"</strong>特点。
                                </p>
                                <p className="text-justify">
                                    排名前三的引用平台分别为：
                                    <strong className="text-white font-bold">腾讯新闻 (6.9%)</strong>、
                                    <strong className="text-white font-bold">百度知道 (5.2%)</strong>和
                                    <strong className="text-white font-bold">今日头条 (3.3%)</strong>。
                                </p>
                                <p className="text-justify border-t border-white/10 pt-3">
                                    这说明 B 端企业物流决策高度依赖大众媒体资讯与行业垂直内容。若不能在这些渠道稳定输出对京东物流有利的仓配、分仓、冷链等 B 端案例，AI 推荐仍会偏向顺丰等既有强势品牌。
                                </p>
                            </div>
