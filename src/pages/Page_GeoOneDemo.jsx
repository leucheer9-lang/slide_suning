...
/* 视频占位框：优先加载 /public/videos/geo-one-demo.mp4，
 * 找不到时回退为纯播放键占位框。后续把视频丢进该路径即可。 */
const VIDEO_SRC = '/videos/geo-one-demo.mp4';
...
export default function Page_GeoOneDemo() {
  const [playing, setPlaying] = useState(false);
...
Page_GeoOneDemo.hideHeader = true;
