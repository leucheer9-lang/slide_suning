...
// ——— 篇章7: 知乎方案新增 ———
import Page_Zhihu_AIData from '../pages/Page_Zhihu_AIData';
import Page_Zhihu_AIDataDecision from '../pages/Page_Zhihu_AIDataDecision';
import Page_Zhihu_AIInternetData from '../pages/Page_Zhihu_AIInternetData';
...
export const slideConfig = [
  ...
  { type: 'page', title: '产品与业务矩阵', component: Page_BrandProducts },
  { type: 'page', title: '核心技术能力壁垒', component: Page_BrandTech },
  { type: 'page', title: '商业模式与渠道触达体系', component: Page_BrandChannel },
  { type: 'page', title: '核心竞品对比分析', component: Page_BrandCompetitors },
  { type: 'page', title: '主流品牌营销获客渠道对比', component: Page_BrandAdMatrix },
  { type: 'page', title: '什么客户会选太力科技', component: Page_BrandWhySuning },
  { type: 'page', title: '同一批客户，谁在截流', component: Page_BrandVerticalCompetitors },
  { type: 'page', title: '竞品获客链路与太力应对', component: Page_BrandVerticalTraffic_A },

  { type: 'section', title: '行业特点' },
  { type: 'page', title: '转型期品牌GEO难点解析', component: Page_IndustryPainPoints },
  { type: 'page', title: '身份错位：AI把太力答成塑料家居用品公司', component: Page_PainPoint1_WordCloud },
  { type: 'page', title: '名称歧义与口径混乱：AI抓到哪条就当事实', component: Page_PainPoint4_SalesModel },
  { type: 'page', title: '头部问题占位：四类推荐名单里太力全部缺席', component: Page_PainPoint2_Industry },
  { type: 'page', title: '公开信息依赖第三方，过时口径持续被AI放大', components: [Page_PainPoint3_Service, Page_PainPoint3_Service_Solution] },
