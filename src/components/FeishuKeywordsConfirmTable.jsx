                ...
                <table className="w-full h-full border-collapse table-fixed">
                    <thead>
                        <tr className="bg-white/[0.04] text-[13px] xl:text-[14px] text-zinc-300 font-semibold">
                            <th className="w-[3.5%] px-1 py-2 border-b border-white/[0.12] text-center font-medium">#</th>
                            <th className="w-[16%] px-2 py-2 border-b border-white/[0.12] text-left">词条生成</th>
                            <th className="w-[8%] px-2 py-2 border-b border-white/[0.12] text-left">词条分类1</th>
                            <th className="w-[9%] px-2 py-2 border-b border-white/[0.12] text-left">词条分类2</th>
                            <th className="w-[6%] px-2 py-2 border-b border-white/[0.12] text-left">词条排序</th>
                            <th className="w-[11%] px-2 py-2 border-b border-white/[0.12] text-left">排序说明</th>
                            <th className="w-[46.5%] px-2 py-2 border-b border-white/[0.12] text-left">关联提示词</th>
                        </tr>
                    </thead>
                    <tbody>
                        {rows.map((row, i) => (
                            ...
                            >
                                <td className="px-1 py-1.5 border-b border-white/[0.08] text-center text-[13px] text-zinc-500 align-middle">
                                    {startIndex + i}
                                </td>
                                <td className="px-2 py-1.5 border-b border-white/[0.08] text-[14px] xl:text-[15px] font-bold text-[#7aa2ff] leading-snug align-middle">
                                    {row.keyword}
                                </td>
                                <td className="px-2 py-1.5 border-b border-white/[0.08] align-middle">
                                ...
                                <td className="px-2 py-1.5 border-b border-white/[0.08] text-[14px] xl:text-[15px] font-semibold text-zinc-200 leading-snug align-middle">
                                    {row.sortNote}
                                </td>
                                <td className="px-2 py-1.5 border-b border-white/[0.08] text-[13px] xl:text-[14px] text-zinc-300 leading-snug align-middle whitespace-pre-line">
                                    {row.prompts}
                                </td>
                            </tr>
                        ))}
