                        ...
                        <table className="w-full text-left border-collapse min-w-[1000px] h-full">
                            <thead>
                                <tr className="border-b-2 border-white/[0.22] text-zinc-300 text-[15.5px] xl:text-[17px] font-black">
                                    ...
                                    <th className="pb-1.5 w-[30%]">运营目标与三阶段演进策略</th>
                            ...
                            <tbody className="text-[15px] xl:text-[16.5px] leading-snug">
                                ...
                                <tr className="hover:bg-white/[0.01] transition-colors duration-200 border-b border-white/[0.22] h-[34%]">
                                    ...
                                    <td className="py-2 text-zinc-300 align-middle pr-3">
                                        <div className="flex flex-col h-full justify-evenly gap-1.5">
                                            <div className="flex items-start gap-2">
                                                <span className="text-[11.5px] xl:text-[12.5px] font-black bg-white/10 text-zinc-200 px-1.5 py-[1px] rounded shrink-0 mt-0.5">阶段一</span>
                                                <div className="text-[14px] xl:text-[15.5px] leading-snug text-justify">
                                            ...
                                            <div className="flex items-start gap-2">
                                                <span className="text-[11.5px] xl:text-[12.5px] font-black bg-white/10 text-zinc-200 px-1.5 py-[1px] rounded shrink-0 mt-0.5">阶段二</span>
                                                <div className="text-[14px] xl:text-[15.5px] leading-snug text-justify">
                                                    <span className="text-white font-black">稳提升｜6个月</span>
                                                    <span className="text-zinc-400 ml-1.5">向“宝安区产业园推荐 / 政策补贴 / 人才公寓”等通用大词与软条件词扩面，把 Top1 持续抬升</span>
                                                </div>
                                            </div>
                                            <div className="flex items-start gap-2">
                                                <span className="text-[11.5px] xl:text-[12.5px] font-black bg-white/10 text-zinc-200 px-1.5 py-[1px] rounded shrink-0 mt-0.5">阶段三</span>
                                                <div className="text-[14px] xl:text-[15.5px] leading-snug text-justify">
                                                    <span className="text-white font-black">稳住｜3个月</span>
                                                    <span className="text-zinc-400 ml-1.5">稳住前二成果，持续压制新桥东等竞品占位，冲击第一</span>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="py-2 text-zinc-300 align-middle pr-3">
                                        <div className="flex flex-col h-full justify-evenly gap-1.5">
                                            <div className="flex items-start gap-2">
                                                ...
                                                <div className="text-[14px] xl:text-[15.5px] leading-snug text-zinc-200 flex flex-col">
                                                    <span>提及率至 <strong className="text-white font-black">30%</strong>　Top1 至 <strong className="text-white font-bold">8%</strong></span>
                                                    <span>进入前三</span>
                                                </div>
                                            </div>
                                            <div className="flex items-start gap-2">
                                                ...
                                                <div className="text-[14px] xl:text-[15.5px] leading-snug text-zinc-200 flex flex-col">
                                                    <span>提及率至 <strong className="text-white font-black">40%</strong>　Top1 至 <strong className="text-white font-bold">15%</strong></span>
                                                    <span>进入前二</span>
                                                </div>
                                            </div>
                                            <div className="flex items-start gap-2">
                                                ...
                                                <div className="text-[14px] xl:text-[15.5px] leading-snug text-zinc-200 flex flex-col">
                                                    <span>提及率至 <strong className="text-white font-black">50%</strong>　Top1 至 <strong className="text-white font-bold">25%</strong></span>
                                                    <span>争取第一</span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <td className="py-2 text-zinc-300 align-middle pr-3 border-l border-white/[0.22] pl-5">
                                        <div className="flex flex-col justify-center gap-1.5 h-full bg-[#004CE5]/5 border border-[#004CE5]/15 p-2.5 xl:p-3 rounded-xl">
                                            <p className="text-zinc-150 text-[13.5px] xl:text-[14.5px] leading-snug text-justify">
                                                在 <strong className="text-white font-bold">DeepSeek、豆包</strong> 搜索企业选址类约定词条时，AI 回答中应出现创维创新谷推荐、推荐理由及园区配置表述。
                                            </p>
                                            <p className="border-t border-white/10 pt-1.5 text-zinc-400 text-[12.5px] xl:text-[13.5px] leading-snug text-justify">
                                    ...
                                    <td className="py-2 text-zinc-300 align-middle pr-3">
                                        <div className="flex flex-col h-full justify-evenly gap-1.5">
                                            ...
                                            <div className="flex items-start gap-2">
                                                ...
                                                <div className="text-[14px] xl:text-[15.5px] leading-snug text-justify">
                                                    <span className="text-white font-black">稳提升｜6个月</span>
                                                    <span className="text-zinc-400 ml-1.5">向“中介带客 / 佣金政策 / 报备流程”等渠道成交词扩面，把提及率与 Top1 持续抬升</span>
                                                </div>
                                            </div>
                                            <div className="flex items-start gap-2">
                                                <span className="text-[11.5px] xl:text-[12.5px] font-black bg-white/10 text-zinc-200 px-1.5 py-[1px] rounded shrink-0 mt-0.5">阶段三</span>
                                                <div className="text-[14px] xl:text-[15.5px] leading-snug text-justify">
                                                    <span className="text-white font-black">稳住｜3个月</span>
                                                    <span className="text-zinc-400 ml-1.5">稳住渠道词占位，持续压制新桥东等竞品，争取第一</span>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="py-2 text-zinc-300 align-middle pr-3">
                                        <div className="flex flex-col h-full justify-evenly gap-1.5">
                                            <div className="flex items-start gap-2">
                                                <span className="text-[11px] xl:text-[12px] font-black bg-[#004CE5]/20 text-[#8cb1ff] border border-[#004CE5]/40 px-1.5 py-[1px] rounded shrink-0 mt-0.5">阶段一考核</span>
                                                <div className="text-[14px] xl:text-[15.5px] leading-snug text-zinc-200 flex flex-col">
                                                    <span>提及率至 <strong className="text-white font-black">15%</strong>　Top1 至 <strong className="text-white font-bold">5%</strong></span>
                                                    <span>进入前五</span>
                                                </div>
                                            </div>
                                            <div className="flex items-start gap-2">
                                                <span className="text-[11px] xl:text-[12px] font-black bg-[#004CE5]/20 text-[#8cb1ff] border border-[#004CE5]/40 px-1.5 py-[1px] rounded shrink-0 mt-0.5">阶段二考核</span>
                                                <div className="text-[14px] xl:text-[15.5px] leading-snug text-zinc-200 flex flex-col">
                                                    <span>提及率至 <strong className="text-white font-black">20%</strong>　Top1 至 <strong className="text-white font-bold">10%</strong></span>
                                                    <span>进入前三</span>
                                                </div>
                                            </div>
                                            <div className="flex items-start gap-2">
                                ...
                                <tr className="hover:bg-white/[0.01] transition-colors duration-200 h-[32%]">
                                    ...
                                    <td className="py-2 text-zinc-300 align-middle pr-3">
                                        <div className="flex flex-col justify-center h-full font-medium bg-[#004CE5]/5 border border-[#004CE5]/15 p-2.5 xl:p-3 rounded-xl text-[13.5px] xl:text-[14.5px] leading-snug text-justify">
                                    ...
                                    <td className="py-2 text-zinc-400 align-middle pr-3 leading-snug border-l border-white/[0.22] pl-5 text-zinc-200">
                                        <div className="flex flex-col justify-center gap-1.5 h-full bg-white/[0.015] border border-white/[0.04] p-2.5 xl:p-3 rounded-xl text-[13.5px] xl:text-[14.5px] text-justify">
                                            <p>
                                                围绕约定 AI 平台及核心词条，持续监测并纠偏“园区无地铁直达、应人石站仍在建、物业推诿不退押金、施工噪音扰民”等表述，通过信源定位与官方内容覆盖，降低 AI 固化负面印象的概率。
                                            </p>
                                            <p className="border-t border-white/10 pt-1.5 text-zinc-400 text-[12.5px] xl:text-[13.5px]">
