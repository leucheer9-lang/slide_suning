...
function Page_GeoKpiAcceptance() {
    return (
        <div className="w-full h-full flex flex-col relative text-white font-sans px-12 sm:px-16 pt-3 pb-3 overflow-hidden animate-fade-in">
            <div className="w-full max-w-[1700px] mx-auto flex flex-col flex-1 min-h-0 relative z-10 pt-0 gap-2.5">

                {/* Header Section */}
                <div className="text-center shrink-0 mb-0 mt-[-12px]">
                ...
                <div className="grid grid-cols-12 gap-3 shrink-0">
                    {/* Panel 1: Tiles */}
                    <div className="col-span-4 bg-white/[0.02] backdrop-blur-xl border border-white/[0.06] border-t-2 border-t-[#004CE5] rounded-2xl py-3.5 px-4.5 flex flex-col justify-between gap-2 shadow-xl hover:bg-white/[0.03] transition-all duration-300">
                        ...
                        <div className="flex items-center gap-8 my-1">
                            <div className="flex flex-col">
                                ...
                                <span className="text-[28px] xl:text-[32px] font-extrabold text-[#004CE5] leading-none mt-1">5.8%</span>
                            </div>
                            <div className="w-px h-10 bg-white/10" />
                            <div className="flex flex-col">
                                <span className="text-zinc-400 text-[13px] xl:text-[14px] font-medium">平均提及位次</span>
                                <span className="text-[28px] xl:text-[32px] font-extrabold text-[#004CE5] leading-none mt-1">NO. 8.1</span>
                            </div>
                        </div>
                    ...
                    <div className="col-span-4 bg-white/[0.02] backdrop-blur-xl border border-white/[0.06] border-t-2 border-t-[#004CE5] rounded-2xl py-3.5 px-4.5 flex flex-col justify-between gap-2 shadow-xl hover:bg-white/[0.03] transition-all duration-300">
                        ...
                        <div className="flex items-center gap-8 my-1">
                            <div className="flex flex-col">
                                <span className="text-zinc-400 text-[13px] xl:text-[14px] font-medium">提及率</span>
                                <span className="text-[28px] xl:text-[32px] font-extrabold text-[#004CE5] leading-none mt-1">0.0%</span>
                            </div>
                            <div className="w-px h-10 bg-white/10" />
                            <div className="flex flex-col">
                                <span className="text-zinc-400 text-[13px] xl:text-[14px] font-medium">平均提及位次</span>
                                <span className="text-[15px] xl:text-[16px] font-bold text-zinc-400 leading-tight mt-1.5">（因未被提及而无排名数据）</span>
                            </div>
                        </div>
                        <p className="text-[14px] xl:text-[15px] text-zinc-300 leading-relaxed">
                    ...
                    <div className="col-span-4 bg-white/[0.02] backdrop-blur-xl border border-white/[0.06] border-t-2 border-t-[#004CE5] rounded-2xl py-3.5 px-4.5 flex flex-col justify-between gap-2 shadow-xl hover:bg-white/[0.03] transition-all duration-300">
                        ...
                        <div className="flex items-center gap-8 my-1">
                            <div className="flex flex-col">
                                ...
                                <span className="text-[28px] xl:text-[32px] font-extrabold text-[#004CE5] leading-none mt-1">11.7%</span>
                            </div>
                        </div>
                        <p className="text-[14px] xl:text-[15px] text-zinc-300 leading-relaxed">
                ...
                <div className="w-full bg-white/[0.02] backdrop-blur-xl border border-white/[0.08] rounded-2xl py-3 px-4.5 shadow-2xl flex flex-col gap-2">
                    <div className="flex items-center justify-between shrink-0 mb-1 pl-1">
                        <h3 className="text-[17px] xl:text-[18.5px] font-bold text-white flex items-center gap-2.5">
                    ...
                    <div className="w-full overflow-x-auto">
                        <table className="w-full text-left border-collapse min-w-[1000px]">
                            <thead>
                                <tr className="border-b border-white/10 text-zinc-300 text-[13.5px] xl:text-[14.5px] font-bold">
                                    <th className="pb-2 pl-3 w-[14%]">词组分类</th>
                                    <th className="pb-2 w-[34%]">运营目标与三阶段演进策略</th>
                                    <th className="pb-2 w-[24%]">阶段性交付标准与 KPI 考核</th>
                                    <th className="pb-2 pr-3 w-[28%] pl-4">最终展现权益及交付标准</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-white/5 text-[12.8px] xl:text-[13.5px] leading-relaxed">
                                
                                {/* Row 1: Tiles */}
                                <tr className="hover:bg-white/[0.01] transition-colors duration-200">
                                    <td className="py-2 pl-3 font-semibold text-zinc-100 align-top">
                                        <div className="flex flex-col gap-1">
                                            <span className="text-[14.5px] xl:text-[15.5px] text-white font-bold">主要产品词</span>
                                            <span className="text-[12px] text-zinc-400 font-medium">（瓷砖）</span>
                                        </div>
                                    </td>
                                    <td className="py-2 text-zinc-300 align-top pr-4">
                                        <div className="flex flex-col gap-1.5">
                                            <div className="flex items-start gap-2">
                                                <span className="text-[11px] xl:text-[12px] font-bold bg-white/10 text-zinc-200 px-1.5 py-[1px] rounded shrink-0 mt-0.5">阶段一</span>
                                                <div className="text-[13px] xl:text-[14px] leading-relaxed">
                                                    <span className="text-white font-semibold">打地基｜3个月</span>
                                                    <span className="text-zinc-400 ml-2">提升基础曝光，打破低提及现状</span>
                                                </div>
                                            </div>
                                            <div className="flex items-start gap-2">
                                                <span className="text-[11px] xl:text-[12px] font-bold bg-white/10 text-zinc-200 px-1.5 py-[1px] rounded shrink-0 mt-0.5">阶段二</span>
                                                <div className="text-[13px] xl:text-[14px] leading-relaxed">
                                            ...
                                            <div className="flex items-start gap-2">
                                                <span className="text-[11px] xl:text-[12px] font-bold bg-white/10 text-zinc-200 px-1.5 py-[1px] rounded shrink-0 mt-0.5">阶段三</span>
                                                <div className="text-[13px] xl:text-[14px] leading-relaxed">
                                    ...
                                    <td className="py-2 text-zinc-300 align-top pr-4">
                                        <div className="flex flex-col gap-1.5 font-medium text-[13px] xl:text-[14px]">
                                            <div className="flex flex-col">
                                    ...
                                    <td rowSpan={2} className="py-2 text-zinc-300 align-middle pr-3 leading-relaxed border-l border-white/5 pl-4">
                                        <div className="flex flex-col gap-2 bg-[#004CE5]/5 border border-[#004CE5]/15 p-3 rounded-xl">
                                            <p className="text-zinc-200 text-[12.8px] xl:text-[13.5px]">
                                                在 <strong className="text-white font-semibold">DeepSeek、豆包、通义千问</strong> 等 AI 平台搜索约定词条时，AI 回答中应出现品牌/产品推荐、推荐理由及基于官方信息的产品表述。
                                            </p>
                                            <p className="border-t border-white/10 pt-2 text-zinc-400 text-[11.8px] xl:text-[12.5px]">
                                ...
                                <tr className="hover:bg-white/[0.01] transition-colors duration-200">
                                    <td className="py-2 pl-3 font-semibold text-zinc-100 align-top">
                                        <div className="flex flex-col gap-1">
                                            <span className="text-[14.5px] xl:text-[15.5px] text-white font-bold">新品词</span>
                                            <span className="text-[12px] text-zinc-400 font-medium">（岩板）</span>
                                        </div>
                                    </td>
                                    <td className="py-2 text-zinc-300 align-top pr-4">
                                        <div className="flex flex-col gap-1.5">
                                ...
                                <tr className="hover:bg-white/[0.01] transition-colors duration-200">
                                    <td className="py-2 pl-3 font-semibold text-zinc-100 align-top">
                                        <div className="flex flex-col gap-1">
                                            <span className="text-[14.5px] xl:text-[15.5px] text-white font-bold">品牌词</span>
                                            <span className="text-[12px] text-zinc-400 font-medium">（负面及错误）</span>
                                        </div>
                                    </td>
                                    <td className="py-2 text-zinc-300 align-top pr-4">
                                        <div className="flex flex-col gap-1.5">
                                    ...
                                    <td className="py-2 text-zinc-300 align-top pr-4">
                                        <div className="flex flex-col gap-1.5 font-medium bg-[#004CE5]/5 border border-[#004CE5]/15 p-2.5 rounded-xl mt-0.5 text-[12.8px] xl:text-[13.5px]">
                                    ...
                                    <td className="py-2 text-zinc-400 align-top pr-3 leading-relaxed border-l border-white/5 pl-4">
                                        <div className="flex flex-col gap-2 bg-white/[0.015] border border-white/[0.04] p-3 rounded-xl">
                                            <p className="text-zinc-200 text-[12.8px] xl:text-[13.5px]">
