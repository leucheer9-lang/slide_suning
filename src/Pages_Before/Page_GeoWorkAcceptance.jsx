                                ...
                                <tr className="hover:bg-white/[0.01] transition-colors duration-200">
                                    <td className="py-3 xl:py-4 pl-3.5 font-semibold text-zinc-100 align-middle border-b border-white/[0.22]">
                                        <div className="flex flex-col gap-1 mt-1">
                                            <span className="text-[18.5px] xl:text-[20.5px] text-white font-black">核心优化词</span>
                                            <span className="text-[15px] xl:text-[16px] text-zinc-400 font-bold">（渠道/场景）</span>
                                        </div>
                                    </td>
                                        ...
                                        <div className="flex flex-col gap-3 xl:gap-3.5">
                                            <div className="flex flex-col gap-1">
                                                ...
                                                <ul className="list-none pl-4 text-zinc-300 flex flex-col gap-1.5 leading-relaxed text-[16.5px] xl:text-[18px]">
                                                    <li>1、<span className="text-white font-semibold">品牌现状诊断：</span>监测苏宁易购提及率、渠道推荐位次、与京东/天猫对比、负面信息及引用来源。</li>
                                                    <li>2、<span className="text-white font-semibold">词条策略规划：</span>规划品牌词、渠道场景词、高转化问题词（送装一体 / 国补与以旧换新 / 3C 选购等），并做优先级分层。</li>
                                                    <li>3、<span className="text-white font-semibold">覆盖平台策略：</span>针对 DeepSeek、豆包、元宝、通义千问制定差异化优化策略，统一苏宁渠道表达口径。</li>
                                                </ul>
                                            </div>
                                            <div className="flex flex-col gap-1">
                                                <div className="flex items-center gap-2 text-[17.5px] xl:text-[19px] font-black text-white mb-1">
                                                ...
                                                <ul className="list-none pl-4 text-zinc-300 flex flex-col gap-1.5 leading-relaxed text-[16.5px] xl:text-[18px]">
                                                    ...
                                                    <li>2、<span className="text-white font-semibold">内容生成与分发：</span>生成渠道对比、服务履约、场景问答、国补以旧换新及负面优化类内容。</li>
                                                    <li>3、<span className="text-white font-semibold">外部平台筛选与发布：</span>筛选资讯门户、短视频与问答等高权重平台，完成合作沟通和内容发布。</li>
                                                    <li>4、<span className="text-white font-semibold">媒体与信号构建：</span>建设可信信息源和多来源引用信号，强化苏宁「全渠道零售 + 送装一体」权威叙事。</li>
                                                </ul>
                                            </div>
                                            <div className="flex flex-col gap-1">
                                                <div className="flex items-center gap-2 text-[17.5px] xl:text-[19px] font-black text-white mb-1">
                                                ...
                                                <ul className="list-none pl-4 text-zinc-300 flex flex-col gap-1.5 leading-relaxed text-[16.5px] xl:text-[18px]">
                                                    <li>1、<span className="text-white font-semibold">数据监测反馈：</span>持续监测核心指标（提及率、TOP 位次、零提及词条），输出报告并调整优化策略。</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="py-3 xl:py-4 text-zinc-300 align-middle pr-4 border-b border-white/[0.22] border-l border-white/[0.22] pl-5">
                                        <div className="flex flex-col gap-2 bg-[#004CE5]/6 border border-[#004CE5]/20 p-3.5 xl:p-4.5 rounded-xl mt-1 shadow-inner">
                                            <p className="text-zinc-100 text-[18px] xl:text-[19.5px] leading-relaxed">
                                                提升核心场景词下的 <strong className="text-white font-bold">AI 渠道推荐曝光和品牌位次</strong>，增加 AI 带来的销售贡献约 <strong className="text-[#6494ff] font-extrabold">5%</strong>，辅助线上线下渠道转化提升约 <strong className="text-white font-bold">5% - 10%</strong>。
                                            </p>
                                        </div>
                                    </td>
                                    ...
                                    <td className="py-3 xl:py-4 text-zinc-300 align-middle pr-4 border-l border-white/[0.22] pl-5">
                                        <div className="flex flex-col gap-3 text-[16.5px] xl:text-[18px] leading-relaxed">
                                            <p className="text-zinc-200">
                                                <strong className="text-white font-bold">1、错误信息监测：</strong>建立错误信息监测机制，系统排查苏宁易购在 AI 回答中出现的售后口碑攻击、国补/价格误写、零售云门店规模误写、错误来源及高频触发问题，定位主要问题类型和引用信源，并制定针对性优化策略。
                                            </p>
                                            <p className="text-zinc-200">
                                    ...
                                    <td className="py-3 xl:py-4 text-zinc-300 align-middle pr-3 leading-relaxed border-l border-white/[0.22] pl-6">
                                        <div className="flex flex-col gap-2 bg-white/[0.025] border border-white/[0.06] p-3.5 xl:p-4.5 rounded-xl shadow-lg">
                                            <p className="text-zinc-200 text-[16px] xl:text-[17px] leading-relaxed">
                                                需品牌方提供 <strong className="text-white font-bold">官方口径、正确服务与价格/国补说明、门店规模证明材料</strong>，并协助确认负面/错误信息的处理优先级和澄清口径。
                                            </p>
                                        </div>
                                    </td>
                                </tr>
