...
function Page_GeoReportDashboard() {
    return (
        <div className="w-full h-full flex flex-col relative text-white font-sans px-12 sm:px-16 pt-5 pb-0 overflow-hidden animate-fade-in">
            ...
            {/* Main Content Layout: Single Centered Image maximized to full remaining space.
                Styling is applied directly to the <img> tag to ensure the border and shadow 
                tightly wrap the image dimensions without any cropping or empty spacing. */}
